// ======================================================================
// LoadCell_Try2.v generated from TopDesign.cysch
// 08/22/2020 at 17:24
...
// PGA_v2_0(Gain=8, Power=3, VddaValue=5, Vref_Input=1, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=PGA_v2_0, CY_CONFIG_TITLE=PGA_1, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PGA_1, CY_INSTANCE_SHORT_NAME=PGA_1, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.3, INSTANCE_NAME=PGA_1, )
module PGA_v2_0_0 (
    Vin,
    Vref,
    Vout);
...
module SW_Tx_UART_v1_50_1 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("0723c6d9-3c4d-4de3-aff6-0f81b7143d27/52f31aa9-2f0a-497d-9a1f-1424095e13e6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
...
module CharLCD_v2_20_2 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("39c73926-d62f-4973-be72-169f89e0489e/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module ADC_DelSig_v3_30_5 (
	...
	cy_clock_v1_0
		#(.id("a2033acd-ccd8-412b-abc7-43ab6019c241/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("a2033acd-ccd8-412b-abc7-43ab6019c241/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
		  .period("1562500000"),
		  .is_direct(0),
...
module top ;
    ...
    SW_Tx_UART_v1_50_1 SW_Tx_UART_1 ();
	...
	cy_psoc3_pins_v1_10
		#(.id("f0021e4f-6a10-43d2-bc72-3654c3276fd6"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("e83e6b18-f5d2-4f78-be2e-5f1b6f329121"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("16b50964-289f-4cd3-9922-8f48db515f07"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    ADC_DelSig_v3_30_5 ADC_DelSig_1 (
        .vplus(Net_43),
        .vminus(Net_29),
        .soc(1'b1),
        .eoc(Net_31),
	...
	cy_psoc3_pins_v1_10
		#(.id("77c9754c-3f3d-431a-a908-e92ee1d41b7e"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
