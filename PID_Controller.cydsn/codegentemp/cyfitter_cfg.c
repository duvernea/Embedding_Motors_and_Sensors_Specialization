...
#define BS_IOPINS0_7_VAL ((const uint8 CYFAR *)0x48000068u)
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG32((void CYFAR *)CYREG_OPAMP0_MX, 0x01020102u);
	CY_SET_XTND_REG32((void CYFAR *)CYREG_OPAMP2_MX, 0x01020102u);
