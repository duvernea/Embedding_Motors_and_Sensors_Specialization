...
module CharLCD_v2_20_1 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("3e81eeae-aaef-4477-a731-86def9fa2d71/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
	...
	wire [0:0] tmpOE__P12_6_net;
	wire [0:0] tmpFB_0__P12_6_net;
	wire [0:0] tmpIO_0__P12_6_net;
	wire [0:0] tmpINTERRUPT_0__P12_6_net;
	electrical [0:0] tmpSIOVREF__P12_6_net;
	...
	cy_psoc3_pins_v1_10
		...
		P12_6
		 (.oe(tmpOE__P12_6_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__P12_6_net[0:0]}),
		  .io({tmpIO_0__P12_6_net[0:0]}),
		  .siovref(tmpSIOVREF__P12_6_net),
		  .interrupt({tmpINTERRUPT_0__P12_6_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__P12_6_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
