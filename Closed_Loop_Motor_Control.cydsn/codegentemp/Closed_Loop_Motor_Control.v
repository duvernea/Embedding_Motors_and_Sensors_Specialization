// ======================================================================
// Closed_Loop_Motor_Control.v generated from TopDesign.cysch
// 09/03/2020 at 09:50
...
module ADC_SAR_v3_10_2 (
	...
	cy_clock_v1_0
		#(.id("333d0d8d-9eab-4c13-beac-6e229b814c76/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("333d0d8d-9eab-4c13-beac-6e229b814c76/16a808f6-2e13-45b9-bce0-b001c8655113"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("34c4a259-17e4-467c-80cb-498728c703ee"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("80e0e83c-656f-4a9f-a921-a6fd20c2e9ec"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__P1_5_net;
	wire [0:0] tmpFB_0__P1_5_net;
	wire [0:0] tmpIO_0__P1_5_net;
	wire [0:0] tmpINTERRUPT_0__P1_5_net;
	electrical [0:0] tmpSIOVREF__P1_5_net;
	...
	cy_psoc3_pins_v1_10
		...
		P1_5
		 (.oe(tmpOE__P1_5_net),
		  .y({Net_107}),
		  .fb({tmpFB_0__P1_5_net[0:0]}),
		  .io({tmpIO_0__P1_5_net[0:0]}),
		  .siovref(tmpSIOVREF__P1_5_net),
		  .interrupt({tmpINTERRUPT_0__P1_5_net[0:0]}),
		  .annotation({Net_32}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__P1_5_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_clock_v1_0
		#(.id("a3d796db-4a8b-4efb-81f9-ed265d819d5a"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
